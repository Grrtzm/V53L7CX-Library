...
This example shows the possibility of VL53L7CX to program detection thresholds. It initializes the VL53L7CX ULD, create 2 thresholds per zone for a 4x4 resolution, and starts a ranging to capture 10 frames.
