# Power modes
This example shows the possibility of VL53L7CX to change power mode. It initializes the VL53L7CX ULD, set a configuration, change the power mode, and starts a ranging to capture 10 frames.
